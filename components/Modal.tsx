...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, onSubmit, title, body, footer, actionLabel, disabled }) => {
    ...
    return (
        <>
            <div className="justify-center items-center flex overflow-x-hidden backdrop-blur-sm overflow-y-auto fixed inset-0 z-50 outline bg-neutral-900 bg-opacity-10">
                <div className="relative w-full lg:w-3/6 mx-auto lg:max-w-3xl lg:h-auto h-auto">
                    {/* CONTENT */}
                    <div className="h-full h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-black outline">
                        {/* FOOTER */}
